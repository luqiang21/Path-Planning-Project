...
left: front means the nearest front vehicle on the car's left lane. <br />
left: rear means the nearest rear vehicle on the car's left lane. <br />
similar meanings for right: front and right: rear.

Together with the nearest vehicles' IDs, I am also displaying the vehicle's predicted
distance to the ego car after $$prev\_size * 0.02s$$.

I am using the spline function header file to generate path. Given previous last two points,
and three points of $$car\_s+30, car\_s+60, car\_s+90$$, the smooth path is generated by using
